...
| Cross-cutting | OpenAPI, i18n + matrix, a11y, dead endpoints, WebSocket, versioning, migration drift, rate limiting, security headers, CSS dead classes, N+1 queries, vuln scanning, response times, visual regression |
