...
```
Sentinel v1.8.1 — Automated QA Sweep for Web Applications
...
---
*Generated by [Sentinel](https://github.com/michelabboud/sentinel-sweep) v1.8.1*
```
...
```
👋 Hello! I'm **Sentinel** v1.8.1. Automated QA sweep for Python, TypeScript, Rust, Go, and PHP web apps — catches console errors, layout bugs, RBAC violations, API schema drift, i18n gaps, a11y issues, and dead endpoints. Use `/sentinel:run hello ID` for the full guide.
```
