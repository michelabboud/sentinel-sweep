...
All version references must match. Currently tracked in 12+ files:
- `plugin.json`, `marketplace.json`, skills, agents, mirrors

The `test-version-consistency.sh` test catches mismatches.
