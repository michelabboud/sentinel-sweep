...
```
👋 Hello! I'm **Sentinel Setup** v1.5.0. Environment detection, Playwright check, framework detection, and settings configuration. Use `/sentinel setup hello ID` for the full guide.
```
